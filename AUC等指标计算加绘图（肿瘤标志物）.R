...
# 修复的绘制所有ROC曲线函数（每9条曲线一个图）- 统一坐标轴版本，带自动图例换行
plot_all_roc_curves_grouped <- function(multi_model_results, single_feature_results, curves_per_plot = 4, legend_width = 30) {
